    ...
    public ResidentResponse updateResident(Long residentId, ResidentAddRequest request) {
        if (request.getPhoneNumber() != null && !request.getPhoneNumber().trim().isEmpty() &&
            ...
            throw new ResponseStatusException(HttpStatus.BAD_REQUEST,
                    "Số điện thoại " + request.getPhoneNumber() + " đã được sử dụng bởi cư dân khác.");
        }
        if (request.getIdNumber() != null && !request.getIdNumber().trim().isEmpty() &&
            ...
            throw new ResponseStatusException(HttpStatus.BAD_REQUEST,
                    "Số CCCD " + request.getIdNumber() + " đã được sử dụng bởi cư dân khác.");
        }
        ...
        if (("Head of Household".equalsIgnoreCase(entity.getFamilyRole())
                || "Chủ hộ".equalsIgnoreCase(entity.getFamilyRole()))
            ...
            if (newHouseholdId == null || !newHouseholdId.equals(currentHouseholdId)) {
                throw new ResponseStatusException(HttpStatus.BAD_REQUEST,
                        "Chủ hộ không được phép chuyển hộ khẩu. Vui lòng đổi vai trò thành viên trước.");
            }
        }

        String newRole = request.getFamilyRole();
        if ("Chủ hộ".equalsIgnoreCase(newRole))
            newRole = "Head of Household";
        else if ("Vợ".equalsIgnoreCase(newRole))
            newRole = "Wife";
        else if ("Chồng".equalsIgnoreCase(newRole))
            newRole = "Husband";
        else if ("Con".equalsIgnoreCase(newRole))
            newRole = "Child";
        else if ("Bố mẹ".equalsIgnoreCase(newRole))
            newRole = "Parent";
        else if ("Thành viên khác".equalsIgnoreCase(newRole))
            newRole = "Member";
        else if ("Khác".equalsIgnoreCase(newRole))
            newRole = "Other";
